...
**Indexes**: ADR-084 … ADR-138 (the evolution stack + the SWE-bench arc, built on the ADR-070…083 baseline)
...
9. **The SWE-bench arc (117–138)** — from real multi-file reasoning to a self-optimizing harness:
